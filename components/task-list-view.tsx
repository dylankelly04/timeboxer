...
export function TaskListView({
  ...
  const scheduledTasks = tasks.filter(
    (t) => hasScheduledTime(t) && !t.completed && !isRolloverTask(t)
  );
  ...
  return (
    <div
      ...
      style={{
        width: width !== null && width !== undefined ? `${width}px` : "50%",
      }}
    >
      {/* Header with toggle */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-card">
        ...
        <div className="flex items-center gap-1 bg-muted rounded-lg p-1">
          <Button
            ...
            className={cn(
              "h-7 px-3 text-xs",
              viewMode === "all" && "bg-background shadow-sm"
            )}
          ...
          <Button
            ...
            className={cn(
              "h-7 px-3 text-xs",
              viewMode === "by-day" && "bg-background shadow-sm"
            )}
    ...
    >
      ...
      >
        <TaskSection
          title="Rollover"
          tasks={rolloverTasks}
          emptyMessage="No rollover tasks"
          isRollover
        />
        <TaskSection
          title="Scheduled"
        ...
        {totalTasks === 0 && (
          <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
            <p className="text-sm">Double click to add a task</p>
          </div>
        )}
      </div>
